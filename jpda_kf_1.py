...
def cart2sph2(x, y, z):
    ...
    for i in range(len(x)):
        ...
        az_val = math.atan2(y[i], x[i]) * 180 / np.pi
...
def main():
    ...
    plt.scatter(all_time_list, all_r_list, label='filtered range (code)', color='green', marker='*')
    ...
    plt.figure(figsize=(12, 6))
    plt.subplot(facecolor="white")
    plt.scatter(all_time_list, all_az_list, label='filtered azimuth (code)', color='green', marker='*')
    ...
    plt.figure(figsize=(12, 6))
    plt.subplot(facecolor="white")
    plt.scatter(all_time_list, all_el_list, label='filtered elevation (code)', color='green', marker='*')
